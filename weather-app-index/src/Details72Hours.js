...
function Details72Hours(props) {
  ...
  useEffect(() => {
    updateDetails(props.location.state.next72HoursIndex.instant.details)
    updateDetail6Hour(props.location.state.next72HoursIndex.next_6_hours.details)
...
export default withRouter(Details72Hours)