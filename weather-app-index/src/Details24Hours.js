...
function Details24Hours(props) {
  ...
  useEffect(() => {
    updateDetails(props.location.state.next24HoursIndex.instant.details)
    updateDetail1Hour(props.location.state.next24HoursIndex.next_1_hours.details)
    updateDetail6Hour(props.location.state.next24HoursIndex.next_6_hours.details)
...
export default withRouter(Details24Hours)