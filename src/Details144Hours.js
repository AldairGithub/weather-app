...
function Details144Hours(props) {
  ...
  useEffect(() => {
    updateDetails(props.location.state.next144HoursIndex.instant.details)
    updateDetail6Hour(props.location.state.next144HoursIndex.next_6_hours.details)
...
export default withRouter(Details144Hours)