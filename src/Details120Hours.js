...
function Details120Hours(props) {
  ...
  useEffect(() => {
    updateDetails(props.location.state.next120HoursIndex.instant.details)
    updateDetail6Hour(props.location.state.next120HoursIndex.next_6_hours.details)
...
export default withRouter(Details120Hours)